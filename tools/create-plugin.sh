#!/usr/bin/env bash
#
# create-plugin.sh - Create a new VECU Antigravity plugin from template
#
...
print_header "🚀 Creating new VECU Antigravity plugin: $PLUGIN_NAME"

# Create directory structure
print_info "Creating directory structure..."
cd "$REPO_ROOT"
mkdir -p "$PLUGIN_DIR"/{src,tests,docs}
...
cat > "$PLUGIN_DIR/plugin.json" <<EOF
{
  ...
  "license": "MIT",
  "homepage": "https://github.com/infiquetra/infiquetra-antigravity-plugins",
  "repository": {
    "type": "git",
    "url": "https://github.com/infiquetra/infiquetra-antigravity-plugins.git"
  },
  "bugs": {
    "url": "https://github.com/infiquetra/infiquetra-antigravity-plugins/issues"
  },
  "engines": {
    "antigravity": ">=1.0.0",
    "python": ">=3.12"
...
#!/usr/bin/env python3
"""
Main script for VECU Antigravity plugin.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="VECU Antigravity Plugin"
    )
    parser.add_argument(
        "--verbose",
        "-v",
