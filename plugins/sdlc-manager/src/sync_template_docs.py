#!/usr/bin/env python3
"""Render sdlc-manager issue template docs from canonical YAML templates."""
...
REFERENCE_PATH = (
    REPO_ROOT / "plugins/sdlc-manager/skills/sdlc-issues/references/templates-reference.md"
)
...
def render_reference() -> str:
    ...
    lines = [
        ...
        "",
        "This file is generated by `plugins/sdlc-manager/src/sync_template_docs.py` from",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Sync sdlc-manager template reference docs from canonical issue templates."
    )
    parser.add_argument(
        "--check",
        action="store_true",
